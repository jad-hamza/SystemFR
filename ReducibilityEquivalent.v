...
Definition reducibility_equivalent_prop T : Prop :=
  forall v1 v2 ρ,
    ...
    reducible_values ρ v1 T ->
    reducible_values ρ v2 T.
...
Lemma reducibility_equivalent_reduces_to:
  forall ρ T e1 e2,
    reduces_to (fun v => reducible_values ρ v T) e1 ->
    ...
    wf T 0 ->
    pfv T term_var = nil ->
    reduces_to (fun v => reducible_values ρ v T) e2.
Proof.
