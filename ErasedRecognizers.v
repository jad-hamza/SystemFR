...
Lemma reducible_values_is_pair:
  forall ρ v,
    reducible_values ρ (is_pair v) T_bool.
Proof.
...
Lemma reducible_values_is_succ:
  forall ρ v,
    reducible_values ρ (is_succ v) T_bool.
Proof.
  destruct v; repeat step || simp_red.
Qed.
...
Lemma reducible_values_is_lambda:
  forall ρ v,
    reducible_values ρ (is_lambda v) T_bool.
Proof.
  destruct v; repeat step || simp_red.
Qed.
...
Lemma reducible_is_pair:
  forall ρ t,
    ...
    reducible ρ t T_top ->
    reducible ρ (boolean_recognizer 0 t) T_bool.
Proof.
...
Lemma reducible_is_succ:
  forall ρ t,
    valid_interpretation ρ ->
    reducible ρ t T_top ->
    reducible ρ (boolean_recognizer 1 t) T_bool.
Proof.
  unfold reduces_to; repeat step.
...
Lemma reducible_is_lambda:
  forall ρ t,
    valid_interpretation ρ ->
    reducible ρ t T_top ->
    reducible ρ (boolean_recognizer 2 t) T_bool.
Proof.
  unfold reduces_to; repeat step.
...
Lemma open_reducible_is_pair:
  forall Θ Γ t,
    open_reducible Θ Γ t T_top ->
    open_reducible Θ Γ (boolean_recognizer 0 t) T_bool.
Proof.
...
Lemma open_reducible_is_succ:
  forall Θ Γ t,
    open_reducible Θ Γ t T_top ->
    open_reducible Θ Γ (boolean_recognizer 1 t) T_bool.
Proof.
...
Lemma open_reducible_is_lambda:
  forall Θ Γ t,
    open_reducible Θ Γ t T_top ->
    open_reducible Θ Γ (boolean_recognizer 2 t) T_bool.
Proof.
